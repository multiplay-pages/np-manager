...
const WORKFLOW_TRANSITIONS: WorkflowTransitionConfig[] = [
  {
    ...
    label: 'Zloz sprawe',
    description: 'Przekaz sprawę do dalszej obslugi.',
  ...
  },
  {
    ...
    label: 'Anuluj',
    description: 'Zamknij szkic bez wysylania do procesu.',
    allowedRoles: WRITE_ROLES,
    requiresReason: true,
    requiresComment: false,
  ...
  },
  {
    ...
    label: 'Oczekiwanie na dawce',
    description: 'Zaznacz, ze sprawa oczekuje na decyzje operatora oddajacego.',
  ...
  },
  {
    ...
    label: 'Potwierdz',
    description: 'Potwierdz obsluge sprawy po stronie biznesowej.',
    allowedRoles: REVIEW_ROLES,
    requiresReason: false,
    requiresComment: false,
    reasonLabel: null,
  ...
  },
  {
    ...
    label: 'Odrzuc',
    description: 'Odrzuc sprawe z czytelnym powodem dla audytu.',
    allowedRoles: REVIEW_ROLES,
    requiresReason: true,
    requiresComment: false,
  ...
  },
  {
    ...
    targetStatus: 'CANCELLED',
    label: 'Anuluj',
    description: 'Anuluj aktywna sprawe przed finalizacja.',
    allowedRoles: WRITE_ROLES,
    requiresReason: true,
    requiresComment: false,
    reasonLabel: 'Powod anulowania',
  ...
  },
  {
    ...
    targetStatus: 'ERROR',
    label: 'Oznacz blad',
    description: 'Zablokuj dalsza obsluge i zapisz przyczyne problemu.',
    allowedRoles: REVIEW_ROLES,
    requiresReason: true,
  ...
  },
  {
    ...
    targetStatus: 'CONFIRMED',
    label: 'Potwierdz',
    description: 'Potwierdz sprawe po odpowiedzi dawcy.',
    allowedRoles: REVIEW_ROLES,
    requiresReason: false,
    requiresComment: false,
    reasonLabel: null,
  ...
  },
  {
    ...
    targetStatus: 'REJECTED',
    label: 'Odrzuc',
    description: 'Zakoncz sprawe negatywnie po odpowiedzi dawcy.',
    allowedRoles: REVIEW_ROLES,
    requiresReason: true,
    requiresComment: false,
    reasonLabel: 'Powod odrzucenia',
  ...
  },
  {
    ...
    targetStatus: 'CANCELLED',
    label: 'Anuluj',
    description: 'Anuluj sprawe podczas oczekiwania na dawce.',
    allowedRoles: WRITE_ROLES,
    requiresReason: true,
    requiresComment: false,
    reasonLabel: 'Powod anulowania',
  ...
  },
  {
    ...
    targetStatus: 'ERROR',
    label: 'Oznacz blad',
    description: 'Zapisz problem procesowy podczas oczekiwania na dawce.',
    allowedRoles: REVIEW_ROLES,
    requiresReason: true,
    requiresComment: true,
    reasonLabel: 'Powod bledu',
  ...
  },
  {
    ...
    targetStatus: 'CANCELLED',
    label: 'Anuluj',
    description: 'Anuluj sprawe po potwierdzeniu biznesowym.',
    allowedRoles: WRITE_ROLES,
    requiresReason: true,
    requiresComment: false,
    reasonLabel: 'Powod anulowania',
...
export function resolveWorkflowTransition(
  ...
  if (!transition) {
    throw AppError.badRequest(
      `Nie mozna zmienic statusu z ${PORTING_CASE_STATUS_LABELS[currentStatus]} na ${PORTING_CASE_STATUS_LABELS[body.targetStatus]}.`,
  ...
  if (!transition.allowedRoles.includes(role)) {
    throw AppError.forbidden(
      'Twoja rola nie moze wykonac tej zmiany statusu.',
  ...
  if (transition.requiresReason && !reason) {
    throw AppError.badRequest(
      `${transition.reasonLabel ?? 'Powod'} jest wymagany dla tej zmiany statusu.`,
