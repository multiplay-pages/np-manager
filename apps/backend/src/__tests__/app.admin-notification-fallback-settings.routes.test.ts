...
describe('admin notification fallback settings routes', () => {
  ...
  it('PUT /api/admin/notification-fallback-settings returns 400 on invalid email format (enabled)', async () => {
    const app = await buildApp()
  ...
  it('PUT /api/admin/notification-fallback-settings accepts disabled fallback with invalid email (BUG #1 fix)', async () => {
    mockUpdateSettings.mockResolvedValue({
  ...
  it('PUT /api/admin/notification-fallback-settings returns 400 on enabled + missing email', async () => {
    const app = await buildApp()
